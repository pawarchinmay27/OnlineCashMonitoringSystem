...
<ul class="topnav" id="myTopnav">
  ...
  <li><a href="/Banking/bank_login.jsp">BANK LOGIN</a></li>
			...
			<div class="form-group col-lg-8 wow fadeInLeft delay-06s" style="margin-top: 50px;text-align: center;margin-left: 200px;">
															<form action="/Banking/auth" method="post">
															
															<div class="control-group">
																					<div class="controls">
																																							Enter The Bank Managers Name<input name="bmname" placeholder="BankManagers Id" class="form-control"><br>
															...
															<div class="control-group">
																					<div class="controls">
																																						Enter Password<input type="password" placeholder="Password" name="bmpassword" class="form-control"><br>
