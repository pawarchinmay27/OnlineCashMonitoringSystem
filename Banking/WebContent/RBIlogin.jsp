...
<ul class="topnav" id="myTopnav">
  ...
  <li><a href="/Banking/bank_login.jsp">BANK LOGIN</a></li>
			...
			<div class="col-lg-8 wow fadeInLeft delay-06s">
																					<div >
																											<img alt="RBI " src="/Banking/images/rbi_login1.jpg" class="img-circle" alt="Cinque Terre" style="margin-left:450px;" width="304" height="236">
																					</div>
																</div><br>
...
<div class="form-group col-lg-8 wow fadeInLeft delay-06s" style="margin-top: 50px;text-align: center;margin-left: 200px;">
															<form action="/Banking/RBIauth" method="post">
															
															<div class="control-group">
																					<div class="controls">
																											ENTER ADMIN NAME<input name="rbiuname" class="form-control" >
																					</div>
																</div><br>
																
															<div class="control-group">
																					<div class="controls">
																													ENTER PASSWORD<input type="password" name="rbipassw" class="form-control" >
																					</div>
																</div>
																			<br>																	
